...
Notable changes to CProReview are tracked here.

## 2026-05-17

### Added

- Added `search.html` as a global search page.
- Added global search behavior for posts and videos.
...
- Consolidated the top navigation into `Reviews & Guides`, `Videos`, `About`, and `Newsletter`.
...
- Improved dark-mode contrast for chips, pagination, search controls, and FAQ panels.
- Improved newsletter form contrast and CTA button readability.

### Fixed

- Fixed featured review overlay layout.
- Restored the red `Review` accent in the CProReview wordmark.
- Removed the About page score badge that blocked the hero image.

## 2025-08

### Added

- Initial post and video content.
- Newsletter signup pages and subscriber bonus page.
- Related posts, comments, and basic SEO metadata.
